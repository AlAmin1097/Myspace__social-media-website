...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link bg-gray">
      <img src="../assets/images/icon.png" alt="AdminLTE Logo" class="brand-image elevation-3" style="opacity: .8">
      <span class="brand-text font-weight-light">Myspace</span>
    </a>
...
?>
  ...
  <footer class="main-footer">
    ...
    <strong><a href="https://github.com/alamin1097" target="_blank">Md. Al-Amin Khan</a></strong>
